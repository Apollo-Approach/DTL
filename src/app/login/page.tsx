  ...
  return (
    <div className="w-full max-w-md mx-auto mt-20 p-8 bg-black border border-white/10 shadow-2xl relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <form onSubmit={handleLogin} className="mb-6 flex flex-col gap-4">
          <input
            type="email"
            value={email}
            ...
            required
            className="bg-zinc-900 border border-white/10 p-3 text-white placeholder-zinc-500 focus:outline-none focus:border-cyan-500 transition-colors"
          />
          <input
            type="password"
            value={password}
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-cyan-500 text-black font-black uppercase tracking-widest text-sm py-4 px-6 hover:bg-cyan-400 transition-colors disabled:opacity-50"
          >
        ...
        <div className="relative mb-6">
          ...
          <div className="relative flex justify-center text-xs">
            <span className="bg-black px-2 text-zinc-500 uppercase tracking-widest">Or</span>
          </div>
        </div>
