...
if (!fs.existsSync('src/lib/scrapers')) {
  fs.mkdirSync('src/lib/scrapers', { recursive: true });
}

const fileContent = `import * as cheerio from 'cheerio';
...
`;
fs.writeFileSync('src/lib/scrapers/churches.ts', fileContent);
console.log('Scraper module created');
