                    ...
                    def run_chromium_fallback():
                        ...
                        with sync_playwright() as p:
                            ...
                            if len(homepage_text) > 50:
                                ...
                                logger.info(f"Successfully extracted {len(homepage_text)} chars from homepage via Chromium fallback.")
                            ...
                            if deep_dive_urls:
                                ...
                                for url in deep_dive_urls:
                                    ...
                                    try:
                                        ...
                                        cr_sub.close()
                                        dives_completed += 1
                                        time.sleep(2) # simple sleep
                                    except Exception as cr_sub_e:
                                        logger.warning(f"Chromium fallback failed to deep dive {absolute_url}: {cr_sub_e}")
                            cr_browser.close()
